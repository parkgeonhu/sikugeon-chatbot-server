"""
Django settings for sikugeon_bot project.
...
SECRET_KEY = 'y$04-8^u(&7$$mf!s@#5$-+!+2tmwf%%o42@k+c3-^r@7g*3g@'
...
ROOT_URLCONF = 'sikugeon_bot.urls'
...
WSGI_APPLICATION = 'sikugeon_bot.wsgi.application'
